...
algeria = Team.create name: 'Algeria', coach: 'Vahid Halilhodzic', flag_url: 'http://www.fifa.com/imgml/logos/xs/ALG.gif', photo_url: 'http://www.fifa.com/mm//Photo/Tournament/Competition/02/22/68/35/2226835_FULL-LND.jpg', group: group_h, description: <<DESCRIPTION
...
argentina = Team.create name: 'Argentina', coach: 'Alejandro Sabella', flag_url: 'http://www.fifa.com/imgml/logos/xs/ARG.gif', photo_url: 'http://www.fifa.com/mm//Photo/Tournament/Competition/02/10/43/75/2104375_FULL-LND.jpg', group: group_f, description: <<DESCRIPTION
...
australia = Team.create name: 'Australia', coach: 'Ange Postecoglou', flag_url: 'http://www.fifa.com/imgml/logos/xs/AUS.gif', photo_url: 
...
belgium = Team.create name: 'Belgium', coach: 'Marc Wilmots', flag_url: 'http://www.fifa.com/imgml/logos/xs/BEL.gif', photo_url: 
...
bosnia = Team.create name: 'Bosnia-Herzegovina', coach: 'Safet Susic', flag_url: 'http://www.fifa.com/imgml/logos/xs/BIH.gif', photo_url: 
...
brazil = Team.create name: 'Brazil', coach: 'Luiz Felipe Scolari', flag_url: 'http://www.fifa.com/imgml/logos/xs/BRA.gif', photo_url: 
...
cameroon = Team.create name: 'Cameroon', coach: 'Volker Finke', flag_url: 'http://www.fifa.com/imgml/logos/xs/CMR.gif', photo_url: 
...
chile = Team.create name: 'Chile', coach: 'Jorge Sampaoli', flag_url: 'http://www.fifa.com/imgml/logos/xs/CHI.gif', photo_url: 
...
colombia = Team.create name: 'Colombia', coach: 'Jose Pekerman', flag_url: 'http://www.fifa.com/imgml/logos/xs/COL.gif', photo_url: 
...
costa_rica = Team.create name: 'Costa Rica', coach: 'Jorge Luis Pinto', flag_url: 'http://www.fifa.com/imgml/logos/xs/CRC.gif', photo_url: 
...
cote_divoire = Team.create name: "Côte d'Ivoire", coach: 'Sabri Lamouchi', flag_url: 'http://www.fifa.com/imgml/logos/xs/CIV.gif', photo_url: 
...
croatia = Team.create name: 'Croatia', coach: 'Niko Kovac', flag_url: 'http://www.fifa.com/imgml/logos/xs/CRO.gif', photo_url: 
...
ecuador = Team.create name: 'Ecuador', coach: 'Reinaldo Rueda', flag_url: 'http://www.fifa.com/imgml/logos/xs/ECU.gif', photo_url: 
...
england = Team.create name: 'England', coach: 'Roy Hodgson', flag_url: 'http://www.fifa.com/imgml/logos/xs/ENG.gif', photo_url: 
...
france = Team.create name: 'France', coach: 'Didier Deschamps', flag_url: 'http://www.fifa.com/imgml/logos/xs/FRA.gif', photo_url: 
...
germany = Team.create name: 'Germany', coach: 'Joachim Low', flag_url: 'http://www.fifa.com/imgml/logos/xs/GER.gif', photo_url: 
...
ghana = Team.create name: 'Ghana', coach: 'Kwesi Appiah', flag_url: 'http://www.fifa.com/imgml/logos/xs/GHA.gif', photo_url: 
...
greece = Team.create name: 'Greece', coach: 'Fernando Santos', flag_url: 'http://www.fifa.com/imgml/logos/xs/GRE.gif', photo_url: 
...
honduras = Team.create name: 'Honduras', coach: 'Luis Fernando Suarez', flag_url: 'http://www.fifa.com/imgml/logos/xs/HON.gif', photo_url: 
...
iran = Team.create name: 'Iran', coach: 'Carlos Queiroz', flag_url: 'http://www.fifa.com/imgml/logos/xs/IRN.gif', photo_url: 
...
italy = Team.create name: 'Italy', coach: 'Cesare Prandelli', flag_url: 'http://www.fifa.com/imgml/logos/xs/ITA.gif', photo_url: 
...
japan = Team.create name: 'Japan', coach: 'Alberto Zaccheroni', flag_url: 'http://www.fifa.com/imgml/logos/xs/JPN.gif', photo_url: 
...
korea_republic = Team.create name: 'Korea Republic', coach: 'Hong Myungbo', flag_url: 'http://www.fifa.com/imgml/logos/xs/KOR.gif', photo_url: 
...
mexico = Team.create name: 'Mexico', coach: 'Miguel Herrera', flag_url: 'http://www.fifa.com/imgml/logos/xs/MEX.gif', photo_url: 
...
netherlands = Team.create name: 'Netherlands', coach: 'Louis Van Gaal', flag_url: 'http://www.fifa.com/imgml/logos/xs/NED.gif', photo_url: 
...
nigeria = Team.create name: 'Nigeria', coach: 'Stephen Keshi', flag_url: 'http://www.fifa.com/imgml/logos/xs/NGA.gif', photo_url: 
...
portugal = Team.create name: 'Portugal', coach: 'Paulo Bento', flag_url: 'http://www.fifa.com/imgml/logos/xs/POR.gif', photo_url: 
...
russia = Team.create name: 'Russia', coach: 'Fabio Capello', flag_url: 'http://www.fifa.com/imgml/logos/xs/RUS.gif', photo_url: 
...
spain = Team.create name: 'Spain', coach: 'Vicente del Bosque', flag_url: 'http://www.fifa.com/imgml/logos/xs/ESP.gif', photo_url: 
...
switzerland = Team.create name: 'Switzerland', coach: 'Ottmar Hitzfeld', flag_url: 'http://www.fifa.com/imgml/logos/xs/SUI.gif', photo_url: 
...
uruguay = Team.create name: 'Uruguay', coach: 'Oscar Tabarez', flag_url: 'http://www.fifa.com/imgml/logos/xs/URU.gif', photo_url: 
...
usa = Team.create name: 'USA', coach: 'Jurgen Klinsmann', flag_url: 'http://www.fifa.com/imgml/logos/xs/USA.gif', photo_url: 
...
def to_date(s)
  DateTime.strptime "#{s}-06:00", '%d/%m %H:%M%z'
end

Match.create stage: :group,
    group: group_a,
    date: to_date('12/06 14:00'),
    stadium: sao_paulo,
    local: brazil,
    visitor: croatia
...
Match.create stage: :group,
    group: group_b,
    date: to_date('18/06 13:00'),
    stadium: rio_de_janeiro,
    local: spain,
    visitor: chile

Match.create stage: :group,
    group: group_b,
    date: to_date('18/06 10:00'),
    stadium: porto_alegre,
    local: australia,
    visitor: netherlands

Match.create stage: :group,
    group: group_b,
    date: to_date('23/06 10:00'),
    stadium: curitiba,
    local: australia,
    visitor: spain
...
Match.create stage: :group,
    group: group_c,
    date: to_date('14/06 10:00'),
    stadium: belo_horizonte,
    local: colombia,
    visitor: greece

Match.create stage: :group,
    group: group_c,
    date: to_date('14/06 19:00'),
    stadium: recife,
    local: cote_divoire,
    visitor: japan
...
Match.create stage: :group,
    group: group_c,
    date: to_date('19/06 10:00'),
    stadium: brasilia,
    local: colombia,
    visitor: cote_divoire

Match.create stage: :group,
    group: group_c,
    date: to_date('19/06 16:00'),
    stadium: natal,
    local: japan,
    visitor: greece
...
Match.create stage: :group,
    group: group_h,
    date: to_date('17/06 16:00'),
    stadium: cuiaba,
    local: russia,
    visitor: korea_republic

Match.create stage: :group,
    group: group_h,
    date: to_date('22/06 10:00'),
    stadium: rio_de_janeiro,
    local: belgium,
    visitor: russia
...
Match.create stage: :group,
    group: group_h,
    date: to_date('22/06 13:00'),
    stadium: porto_alegre,
    local: korea_republic,
    visitor: algeria

Match.create stage: :group,
    group: group_h,
    date: to_date('26/06 14:00'),
    stadium: sao_paulo,
    local: korea_republic,
    visitor: belgium
